...
module.exports = {
  content: [
    ...
    './src/app/locale/test/**/*.{js,ts,jsx,tsx,mdx}',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
    ...
    animation: {
      ...
      'fade-in-up': 'fade-in-up 1.6s ease-in-out',
      'fade-in-down': 'fade-in-down 1.6s ease-in-out',
      'fade-in-left': 'fade-in-left 1.6s ease-in-out',
      'fade-in-right': 'fade-in-right 1.6s ease-in-out',
      ...
      'blurred-fade-in': 'blurred-fade-in 1s ease-in-out',
